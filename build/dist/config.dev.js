...
var config = {}; // Configuration file example. 
//
...
config.DS_APP_URL = 'https://legendary-speculoos-588c31.netlify.app'; // config.DS_APP_URL='http://localhost:3000/react-oauth-docusign/build';
...
config.IMPLICIT_SCOPES = 'signature cors'; // DocuSign Identity server

config.DS_IDP = 'https://account-d.docusign.com'; // Your private API CORS proxies
...
config.DS_API_CORS_PROXIES = {
  ...
  'https://demo.docusign.net': 'https://demo.docusign.net' //  'https://demo.docusign.net':'https://account-d.docusign.com/oauth',
